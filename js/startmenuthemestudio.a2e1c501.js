    ...
    ["startmenu~themestudio"], {
        ...
        "3cb5": function(t, e, s) {
            ...
            var l = function() {
                    ...
                    return l("winui-menubar", {
                        ...
                        }, [t.items && !t.disabled ? [l("menu-item-button", e._b({}, "menu-item-button", e.bindProps(t), !1)), l("base-menu", {
                            staticClass: "can-hover",
                            attrs: {
                                items: t.items
                            }
                        })] : l("menu-item-button", e._b({
                            attrs: {
                                disabled: t.disabled
                            },
                            on: {
                                click: function(s) {
                                    return s.stopPropagation(), e.click(t.click)
                                }
                            }
                ...
                n = a,
                c = (s("ce26"), s("2877")),
                h = Object(c["a"])(n, l, i, !1, null, null, null);
            e["a"] = h.exports
        },
        4615: function(t, e, s) {},
        "5c9b": function(t, e, s) {
            ...
            var l = function() {
                    ...
                    return s("button", {
                        directives: [{
                            ...
                            value: t.openMenu(t.program.key),
                            expression: "openMenu(program.key)",
                            arg: "touchhold"
                        }],
                        staticClass: "relative flex items-center gap-2 hover:bg-black/10 focus:bg-black/10 px-1 py-2 border border-transparent border-solid w-full text-base text-left startmenu__program-item",
                        attrs: {
                            "data-icon": t.program.key,
                            "data-test-program": t.program.key
                        },
                        on: {
                            click: t.handleClick,
                            contextmenu: function(e) {
                                return t.openMenu(t.program.key)(e)
                            }
                        }
                    }, [s("base-icon", {
                ...
                o = {
                    ...
                    methods: {
                        ...
                        openMenu(t) {
                            return e => this.$bus.$emit("openMenu", {
                                e: e,
                                id: t
                            })
                        }
                ...
                a = o,
                n = s("2877"),
                c = Object(n["a"])(a, l, i, !1, null, null, null);
            e["a"] = c.exports
        },
        "6fba": function(t, e, s) {
            "use strict";
            var l = function() {
                    ...
                    }, [t._t("default"), t.showVerticalScrollbar ? s("scrollbar", {
                    ...
                    }) : t._e(), t.showHorizontalScrollbar ? s("scrollbar", {
            ...
            var u = {
                    ...
                    methods: { ...a["c"].mapMutations([a["a"].OpenContextMenu]),
                        openMenu(t) {
                            t.preventDefault(), this.menuDisabled || this[a["a"].OpenContextMenu]({
                                e: t,
                        ...
                        handleThumbDrag(t) {
                            ...
                            const e = this.$refs.scrollbar,
                                s = this.isHorizontal ? e.clientWidth : e.clientHeight,
                                l = this.isHorizontal ? this.thumbHeightHorizon : this.thumbHeight,
                                i = l / 100 * s,
                                r = s - i,
                                o = this.isHorizontal ? this.element.scrollWidth - this.element.clientWidth : this.element.scrollHeight - this.element.clientHeight,
                                a = t.clientX - this.dragStartX,
                                n = t.clientY - this.dragStartY,
                                c = (this.isHorizontal ? a : n) / r * o;
                        ...
                        handleTrackClick(t) {
                            const e = this.$refs.scrollbar,
                                ...
                                m = u / h;
                            this.isHorizontal ? this.element.scrollLeft = m * d : this.element.scrollTop = m * d;
                            const b = this.isHorizontal ? this.thumbTopHorizon : this.thumbTop,
                                p = b / 100 * l,
                                f = p + r / 2;
                            this.isHorizontal ? this.trackClickDirection = o < f ? "left" : "right" : this.trackClickDirection = a < f ? "up" : "down", setTimeout(() => this.trackClickDirection = null, 200)
                        },
                        scroll(t) {
                            switch (t) {
                                case "up":
                ...
                d = u,
                m = s("2877"),
                b = Object(m["a"])(d, r, o, !1, null, null, null),
                p = b.exports;
            ...
            var g = {
                    ...
                    async mounted() {
                        ...
                        const l = null === (t = this.$refs) || void 0 === t ? void 0 : t.scrollbarWrapper;
                        if (this.element = this.elClass && (null === l || void 0 === l ? void 0 : l.querySelector(this.elClass)) || (null === (e = this.$slots.default) || void 0 === e || null === (s = e[0]) || void 0 === s ? void 0 : s.elm), !this.element) throw new Error("No elements found to observe changes.");
                    ...
                    beforeDestroy() {
                        var t, e, s;
                        null === (t = this.resizeObserver) || void 0 === t || t.disconnect(), null === (e = this.mutationObserver) || void 0 === e || e.disconnect(), null === (s = this.element) || void 0 === s || s.removeEventListener("scroll", this.updateScrollbar)
                    },
                    watch: {
                    ...
                    methods: {
                        updateScrollbar() {
                            var t, e, s, l;
                            this.isScrollableVertically = this.element.clientHeight < this.element.scrollHeight, null === (t = this.$refs) || void 0 === t || null === (e = t.verticalScrollbar) || void 0 === e || e.updateScrollbar(), this.isScrollableHorizontally = this.element.clientWidth < this.element.scrollWidth, null === (s = this.$refs) || void 0 === s || null === (l = s.horizontalScrollbar) || void 0 === l || l.updateScrollbar()
                        },
                ...
                v = g,
                k = Object(m["a"])(v, l, i, !1, null, null, null);
            e["a"] = k.exports
        },
        "9acc": function(t, e, s) {
            "use strict";
            var l = function() {
                    ...
                    return s("transition", {
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: t.isOpen || t.asDecorator,
                            expression: "isOpen || asDecorator"
                        }],
                        staticClass: "absolute flex gap-2 bg-white p-2 startmenu__wrapper",
                        attrs: {
                            id: "start-menu",
                            "data-test-start-menu": ""
                        }
                    }, [s("div", {
                        staticClass: "relative flex flex-col border border-black/10 border-solid w-80 h-full startmenu__left"
                    }, [s("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                        ...
                        staticClass: "p-2 overflow-auto startmenu__program-list",
                        attrs: {
                            "data-test-list-recent": ""
                        }
                    }, t._l(t.recentPrograms, (function(e) {
                        return s("start-program", {
                            key: e.key,
                            staticClass: "is-recent",
                            attrs: {
                                program: e
                            },
                            on: {
                        ...
                        staticClass: "p-2 startmenu__program-list is-all",
                        attrs: {
                            "data-test-list-all": ""
                        }
                        ...
                        staticClass: "flex flex-col startmenu__nav"
                    }, [s("hr", {
                        staticClass: "bg-black/10 mx-auto mb-2 border-0 startmenu__divider"
                    }), s("button", {
                        staticClass: "relative flex items-center gap-6 hover:bg-black/10 focus:bg-black/10 mx-2 mb-2 p-2 border border-transparent border-solid startmenu__all",
                        class: t.showAll ? "is-back" : "",
                        attrs: {
                            "data-test-all-programs": ""
                        },
                        on: {
                            click: function(e) {
                                t.showAll = !t.showAll
                        ...
                        attrs: {
                            icon: t.showAll ? "fa:caret-left" : "fa:caret-right"
                        }
                    }), s("span", [t._v(t._s(t.showAll ? t.$t("back") : t.$t("all-programs")))])], 1), s("div", {
                        staticClass: "px-2 pb-2 startmenu__search"
                    }, [s("winui-searchbox", {
                        staticClass: "w-full placeholder:italic",
                        attrs: {
                            instant: "",
                        ...
                        staticClass: "relative flex flex-col gap-1 w-48 startmenu__right"
                    }, [t.showItemPreview ? s("div", {
                        staticClass: "-top-16 left-1/2 absolute w-28 h-28 startmenu__avatar"
                        ...
                        }, [t.hoveredLink === e.key ? s("img", {
                            staticClass: "top-[10%] left-[10%] absolute m-auto w-4/5 h-4/5",
                            attrs: {
                                src: e.icon
                            }
                        }) : t._e()])
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: t.showAccountLink,
                            expression: "showAccountLink"
                        }],
                        staticClass: "w-full h-full",
                        attrs: {
                            size: 57
                    ...
                    })], 1)], 2) : t._e(), t._l(t.shortcuts, (function(e) {
                        return s("button", {
                            key: e.key,
                            class: ["relative flex flex-col flex-1 justify-center hover:bg-black/10 focus:bg-black/10 p-2 border border-transparent border-solid text-left startmenu__link", {
                                "mb-0.5 has-line": "computer" === e.key
                            }],
                            on: {
                                click: e.action,
                                mouseover: function(s) {
                                    return t.showLinkIcon(e.key)
                                },
                                mouseout: function(e) {
                                    return t.showLinkIcon("")
                                }
                            }
                        }, [t._v(" " + t._s(e.lbl) + " ")])
                    })), s("div", {
                        staticClass: "relative flex self-start mt-8 py-1 startmenu__groupbutton"
                    }, [s("button", {
                        staticClass: "hover:bg-black/10 focus:bg-black/10 p-2 border border-black/20 border-solid min-w-16 startmenu__button",
                        attrs: {
                            "data-test-startmenu-action": "shutdown"
                        },
                        on: {
                            click: t.shutdown
                        }
                    }, [t._v(" " + t._s(t.$t("shutdown")) + " ")]), s("button", {
                        staticClass: "center-flex hover:bg-black/10 focus:bg-black/10 p-2 border border-black/20 border-l-0 border-solid min-w-4 is-last startmenu__button",
                        attrs: {
                            "aria-label": "Show shutdown options"
                        }
                    }, [s("iconify-icon", {
                        attrs: {
                            icon: "fa:caret-right"
                        ...
                        staticClass: "hidden bottom-0 left-full startmenu__menu",
                        attrs: {
                            "data-test-startmenu-actions": ""
                        }
                    }, [s("winui-menuitem", [s("button", {
                        attrs: {
                            "data-test-startmenu-action": "switch"
                        },
                        on: {
                            click: t.switchUser
                        }
                    }, [t._v(t._s(t.$t("switch-user")))])]), s("winui-menuitem", {
                        on: {
                            click: t.logoff
                        }
                    }, [s("button", {
                        attrs: {
                            "data-test-startmenu-action": "logoff"
                        },
                        on: {
                            click: t.logoff
                        }
                    }, [t._v(t._s(t.$t("logoff")))])]), s("winui-menuitem", {
                        on: {
                            click: t.restart
                        }
                    }, [s("button", {
                        attrs: {
                            "data-test-startmenu-action": "restart"
                        },
                        on: {
                            click: t.restart
                        }
                    }, [t._v(t._s(t.$t("restart")))])])], 1)], 1)], 2)])])
                },
                i = [],
                r = s("6792"),
                o = s("bf00"),
                ...
                b = {
                    ...
                    data() {
                        return {
                            ...
                            hoveredLink: "",
                            showAccountLink: !0,
                            showAccountLinkTimeout: null
                        }
                    },
                    computed: { ...Object(u["f"])({
                            systemPath: t => t.systemPath,
                            programs({
                                programs: t
                            }) {
                                return t.map(t => ({
                        ...
                        shortcuts() {
                            ...
                            return [{
                                ...
                                icon: t.default,
                                action: () => Object(h["launchSetting"])(r["a"].ACTION_MANAGE_DEFAULT_APPS_SETTINGS)
                            }, {
                                key: "help",
                        ...
                        showItemPreview() {
                            return !this.isBaseTheme && !this.isCustomTheme && !this.asDecorator
                        }
                    },
                    watch: {
                        fullList: {
                    ...
                    methods: {
                        search(t) {
                            ...
                            e ? (this.showAll = !0, this.searchList = this.searchList.filter(t => t.lbl.toLowerCase().includes(e.toLowerCase()))) : (this.showAll = !1, this.searchList = this.fullList.slice(0))
                        },
                        showLinkIcon(t) {
                            clearTimeout(this.showAccountLinkTimeout), this.showAccountLinkTimeout = setTimeout(() => {
                                this.hoveredLink = t, this.showAccountLink = !t
                            }, 400)
                        }
                    },
                    components: {
                        AvatarWin7: o["a"],
                        ScrollbarContainer: n["a"],
                        StartProgram: c["a"]
                    }
                },
                p = b,
                f = (s("0fdd"), s("2877")),
                g = Object(f["a"])(p, l, i, !1, null, null, null);
            e["a"] = g.exports
        },
        "9e81": function(t, e, s) {
            "use strict";
            ...
            e["a"] = n["default"].extend({
                ...
                computed: { ...Object(r["d"])({
                    ...
                    icon() {
                        return this.asDecorator ? this.baseAssets.icon : this.themeData.icon
                    }
                },
                methods: { ...l["c"].mapMutations([l["a"].SetTempData]),
                    ...i["e"].mapActions([i["b"].ProgramEvent]),
                    open(t, e) {
                        e && this[l["a"].SetTempData]({
                            path: e
                        }), this.$root.$emit(o["c"].OpenWindow, t), this.$store.commit(a["a"].Start, !1)
                    },
                    openMenu(t, e) {
                    ...
                    async logoff() {
                        await (this.user ? c["c"].logout() : Promise.resolve()), this.switchUser(), this.$store.commit(a["a"].User, null), this[i["b"].ProgramEvent](i["c"].Windows.Logoff)
                    },
                    shutdown() {
                        this.$bus.$emit("changeView", {
                            view: "Shutdown"
        ...
        bf00: function(t, e, s) {
            ...
            var l = function() {
                ...
                n = {
                    ...
                    computed: { ...Object(a["f"])({
                        ...
                        avatar() {
                            ...
                            return Object(o["e"])(t) ? t : Object(o["a"])(this.assets.accs, t) || Object(o["a"])(this.assets.accs, "guest")
                        },
                        frame() {
                            return Object(o["a"])(this.assets.misc, "acc-frame")
                        }
                    },
                    mounted() {
                        const t = 13 / 19,
                ...
                c = n,
                h = (s("ab2e"), s("2877")),
                u = Object(h["a"])(c, l, i, !1, null, null, null);
            e["a"] = u.exports
        },
        c453: function(t, e, s) {
            "use strict";
