(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["about", "device", "hotkey", "storage"], {
        ...
        "0e9a": function(e, t, n) {
            ...
            function a(e) {
                return I(e, /(webp|apng|png|jpg|jpeg|jfif|svg|gif|ico)$/)
            }

            function c(e) {
                return I(e, /(txt|text|readme|md|json|xml|rtf|wpl)$/)
            }
            ...
            function d(e) {
                return I(e, /(webm|mp4|mpg|mpeg|ogm|wmv|avi|mov)$/)
            }

            function l(e) {
                return I(e, /(webm|mp3|ogg|wav|wma|aac|m4a|flac|mid)$/)
            }

            function f(e) {
                return I(e, /(exe|msi|apk)$/)
            }
        ...
        "2ea7": function(e, t, n) {
            ...
            let T = [],
                ...
                _ = "all";
            const p = [],
                I = e => c[e.toLowerCase()] || u[e.toLowerCase()] || e.toUpperCase().charCodeAt(0),
                h = e => Object.keys(c).find(t => c[t] === e),
            ...
            function O() {
                return T.map(e => h(e) || m(e) || String.fromCharCode(e))
            }
            ...
            function b(e) {
                return "string" === typeof e && (e = I(e)), -1 !== T.indexOf(e)
            }
            ...
            function v(e, t) {
                ...
                const r = N();
                if (n)
                    for (let i = 0; i < n.length; i++) n[i].scope === r && ("keydown" === e.type && n[i].keydown || "keyup" === e.type && n[i].keyup) && G(e, n[i], r, t);
                if (o in f)
                    for (let i = 0; i < f[o].length; i++)
                        if (("keydown" === e.type && f[o][i].keydown || "keyup" === e.type && f[o][i].keyup) && f[o][i].key) {
                            const n = f[o][i],
                                ...
                                a = n.key.split(s),
                                c = [];
                            for (let e = 0; e < a.length; e++) c.push(I(a[e]));
                            c.sort().join("") === T.sort().join("") && G(e, n, r, t)
                        }
            }
            ...
            function x(e, t, n) {
                ...
                let a = [],
                    ...
                    g = !1,
                    N = !1;
                for (void 0 === n && "function" === typeof t && (n = t), "[object Object]" === Object.prototype.toString.call(t) && (t.scope && (c = t.scope), t.element && (d = t.element), t.keyup && (_ = t.keyup), void 0 !== t.keydown && (h = t.keydown), void 0 !== t.capture && (g = t.capture), "string" === typeof t.splitKey && (m = t.splitKey), !0 === t.single && (N = !0)), "string" === typeof t && (c = t), N && R(e, c); l < o.length; l++) e = o[l].split(m), a = [], e.length > 1 && (a = i(u, e)), e = e[e.length - 1], e = "*" === e ? "*" : I(e), e in f || (f[e] = []), f[e].push({
                    keyup: _,
                    keydown: h,
                    scope: c,
                    mods: a,
                ...
                "undefined" !== typeof d && !k(d) && window && (p.push(d), r(d, "keydown", e => {
                    v(e, d)
                }, g), S || (S = !0, r(window, "focus", () => {
                    T = []
                }, g)), r(d, "keyup", e => {
                    v(e, d), y(e)
                }, g))
            ...
            for (const M in U) Object.prototype.hasOwnProperty.call(U, M) && (x[M] = U[M]);
        ...
        "52fa": function(e, t, n) {
            ...
            var o = function() {
                    ...
                    return n("window-main", {
                        ...
                        staticClass: "center-flex gap-2 mb-6"
                    }, [n("img", {
                        attrs: {
                            src: e.brand,
                            width: "44",
                        ...
                        staticClass: "text-5xl leading-[44px]"
                    }, [e._v("Windows"), n("sup", {
                        staticClass: "text-xs"
                    }, [e._v("®")]), e._v(" 7")]), n("span", {
                        staticClass: "self-end font-thin text-3xl leading-[32px]"
                    }, [e._v("Simulator")])]), n("hr", {
                        staticClass: "mx-auto mb-6 border-0 border-black/60 border-b w-5/6"
                    }), n("div", {
                        staticClass: "mx-auto max-w-md text-base"
                    }, [n("text-regular", [n("winui-link", {
                        attrs: {
                            href: "https://visnalize.com",
                            target: "_blank",
                            text: "Visnalize"
                        }
                    })], 1), n("text-regular", [e._v("Version " + e._s(e.version) + " (Offline Patched)")]), n("text-regular", [e._v("Windows 7 Copyright © Microsoft Corporation.")]), n("text-regular", [e._v(" Win7 Simu Offline Patched by giangnam0201 & Antigravity (Removed Ads & Premium). Original app built by Visnalize. entertainment purposes only. It is in no way associated with Microsoft. ")])], 1), n("div", {
                        staticClass: "my-auto text-center"
                    }, [n("winui-link", {
                        attrs: {
                            href: "https://visnalize.com/win7simu/privacy",
                            target: "_blank",
                            text: "Privacy Policy",
                            "data-test-about": "privacy"
                        }
                    }), e._v(" - "), n("winui-link", {
                        attrs: {
                            href: "https://visnalize.com/win7simu/changelog",
                            target: "_blank",
                            text: "Changelog",
                            "data-test-about": "changelog"
                        }
                    }), e._v(" - "), n("winui-link", {
                        attrs: {
                            href: "https://github.com/Visnalize/win7-simu/issues/new/choose",
                            target: "_blank",
                            text: "Report bugs",
                            "data-test-about": "bugs"
                        }
                    })], 1), n("div", {
                        staticClass: "flex justify-end"
                    }, [n("winui-button", {
                        attrs: {
                            "data-test-credits-button": ""
                        },
                        on: {
                            click: function(t) {
                                return e.openLink("https://visnalize.com/win7simu/credits")
                            }
                        }
                    }, [e._v(" Credits ")])], 1)])], 1)
                },
                ...
                T = {
                    data() {
                        ...
                        return {
                            brand: Object(l["a"])(e, "start-button-classic"),
                            version: f["a"]
                        }
                    },
                    methods: {
                ...
                S = T,
                _ = n("2877"),
                p = Object(_["a"])(S, o, r, !1, null, null, null);
            t["default"] = p.exports
        },
        "554d": function(e, t, n) {
            "use strict";
