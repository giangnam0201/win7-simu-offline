            ...
            (function(n) {
                ...
                (function(n) {
                    ...
                    return function e(n, r, o) {
                        ...
                        for (var a = "function" == typeof t && t, u = 0; u < o.length; u++) i(o[u]);
                        return i
                    }({
                        1: [function(e, t, r) {
                            (function(e) {
                        ...
                        2: [function(e, n, t) {
                            ...
                            n.exports = f, f.prototype["catch"] = function(e) {
                                ...
                                if (this.state !== c) {
                                    var r = this.state === u ? e : n;
                                    l(t, r, this.outcome)
                                } else this.queue.push(new s(t, e, n));
                                return t
                                ...
                                if (r) v(e, r);
                                    ...
                                    var o = -1,
                                        a = e.queue.length;
                                    while (++o < a) e.queue[o].callFulfilled(n)
                                }
                                return e
                                ...
                                var t = -1,
                                    r = e.queue.length;
                                while (++t < r) e.queue[t].callRejected(n);
                                return e
                        ...
                        4: [function(e, n, t) {
                            ...
                            function c(e, n) {
                                ...
                                try {
                                    ...
                                    for (var t = "undefined" !== typeof BlobBuilder ? BlobBuilder : "undefined" !== typeof MSBlobBuilder ? MSBlobBuilder : "undefined" !== typeof MozBlobBuilder ? MozBlobBuilder : WebKitBlobBuilder, r = new t, o = 0; o < e.length; o += 1) r.append(e[o]);
                            ...
                            function J(e, n) {
                                ...
                                if (e.name) {
                                    var i = e.name === t.name && o._dbInfo.db,
                                        u = i ? f.resolve(o._dbInfo.db) : R(e).then((function(n) {
                                            var t = p[e.name],
                                                r = t.forages;
                                            t.db = n;
                                    ...
                                    r = e.storeName ? u.then((function(n) {
                                        if (n.objectStoreNames.contains(e.storeName)) {
                                            ...
                                            var c = new f((function(n, r) {
                                                ...
                                                o.onerror = function(e) {
                                                    ...
                                                    var n = o.result;
                                                    n.deleteObjectStore(e.storeName)
                            ...
                            function ve(e) {
                                ...
                                var f = new ArrayBuffer(a),
                                    s = new Uint8Array(f);
                                for (n = 0; n < u; n += 4) t = G.indexOf(e[n]), r = G.indexOf(e[n + 1]), o = G.indexOf(e[n + 2]), i = G.indexOf(e[n + 3]), s[c++] = t << 2 | r >> 4, s[c++] = (15 & r) << 4 | o >> 2, s[c++] = (3 & o) << 6 | 63 & i;
                                return f
                            }
                            ...
                            function he(e) {
                                var n, t = new Uint8Array(e),
                                    r = "";
                                for (n = 0; n < t.length; n += 3) r += G[t[n] >> 2], r += G[(3 & t[n]) << 4 | t[n + 1] >> 4], r += G[(15 & t[n + 1]) << 2 | t[n + 2] >> 6], r += G[63 & t[n + 2]];
                                            ...
                                            o.db.transaction((function(t) {
                                                _e(t, o, "SELECT * FROM " + o.storeName, [], (function(t, r) {
                                                    for (var i = r.rows, a = i.length, u = 0; u < a; u++) {
                                                        var c = i.item(u),
                                                            f = c.value;
                                                        if (f && (f = o.serializer.deserialize(f)), f = e(f, c.key, u + 1), void 0 !== f) return void n(f)
                                                    }
                                                    n()
                                                }), (function(e, n) {
                                                    r(n)
                                    ...
                                    r = t.ready().then((function() {
                                        for (var n = t._dbInfo, r = n.keyPrefix, o = r.length, i = localStorage.length, a = 1, u = 0; u < i; u++) {
                                            ...
                                            if (0 === c.indexOf(r)) {
                                                ...
                                                if (f && (f = n.serializer.deserialize(f)), f = e(f, c.substring(o), a++), void 0 !== f) return f
                                            }
                                        }
                                    }));
                                return s(r, n), r
                            ...
                            function Je(e, n) {
                                if (n = v.apply(this, arguments), e = "function" !== typeof e && e || {}, !e.name) {
                                    var t = this.config();
                                        ...
                                        var r = new f((function(n, t) {
                                            try {
                                                ...
                                                for (var i = tn.concat("_initStorage"), a = 0, u = i.length; a < u; a++) {
                                                    var c = i[a],
                                                        l = !Ge(nn, c);
                                                    if ((l || e[c]) && "function" !== typeof e[c]) return void t(o)
                                                }
                                                var d = function() {
                                                ...
                                                "_support" in e ? e._support && "function" === typeof e._support ? e._support().then(v, t) : v(!!e._support) : v(!0)
                                            } catch (h) {
                                                t(h)
                                            }
                                        }));
