(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["about~bin~bsod~calc~camera~chess~chrome~cmd~computer~cpanel~g-battery~g-calendar~g-clock~g-currency~~bd97ba14"], {
        "2f62": function(t, e, n) {
            "use strict";
            (function(t) {
                function r(t) {
                ...
                var y = function(t) {
                        ...
                        $(this, u, [], this._modules.root), M(this, u), n.forEach((function(t) {
                            return t(e)
                        }));
                ...
                function M(t, e, n) {
                    ...
                    var c = g.config.silent;
                    g.config.silent = !0, t._vm = new g({
                        data: {
                            $$state: e
                        },
                        computed: i
                    }), g.config.silent = c, t.strict && A(t), r && (n && t._withCommit((function() {
                        r._data.$$state = null
                    })), g.nextTick((function() {
                        return r.$destroy()
                    })))
                ...
                function $(t, e, n, r, o) {
                    ...
                    if (r.namespaced && (t._modulesNamespaceMap[c], t._modulesNamespaceMap[c] = r), !i && !o) {
                        var a = x(e, n.slice(0, -1)),
                            s = n[n.length - 1];
                        t._withCommit((function() {
                            g.set(a, s, r.state)
                        }))
                    }
                    var u = r.context = C(t, c, n);
                ...
                _.state.get = function() {
                    ...
                    void 0 === n && (n = {}), "string" === typeof t && (t = [t]), this._modules.register(t, e), $(this, this.state, t, this._modules.get(t), n.preserveState), M(this, this.state)
                ...
                function R(t) {
                    ...
                    return void 0 === f && (f = console),
                        function(t) {
                            var l = s(t.state);
                            "undefined" !== typeof f && (a && t.subscribe((function(t, i) {
                                var c = s(i);
                                if (n(t, l, c)) {
                                    var a = K(),
                                        u = o(t),
                                        p = "mutation " + t.type + a;
                                    U(f, p, e), f.log("%c prev state", "color: #9E9E9E; font-weight: bold", r(l)), f.log("%c mutation", "color: #03A9F4; font-weight: bold", u), f.log("%c next state", "color: #4CAF50; font-weight: bold", r(c)), B(f)
                                }
                                l = c
                                ...
                                if (i(t, n)) {
                                    var r = K(),
                                        o = c(t),
                                        a = "action " + t.type + r;
                                    U(f, a, e), f.log("%c action", "color: #03A9F4; font-weight: bold", o), B(f)
                                }
                            })))
                        }
                }
