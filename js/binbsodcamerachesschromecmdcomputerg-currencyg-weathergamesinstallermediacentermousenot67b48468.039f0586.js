(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["bin~bsod~camera~chess~chrome~cmd~computer~g-currency~g-weather~games~installer~mediacenter~mouse~not~67b48468", "storage"], {
        "1c35": function(t, r, e) {
            "use strict";
            (function(t) {
                var n = e("1fb5"),
                ...
                function s(t, r) {
                    ...
                    return a.TYPED_ARRAY_SUPPORT ? (t = new Uint8Array(r), t.__proto__ = a.prototype) : (null === t && (t = new a(r)), t.length = r), t
                }
                ...
                function p(t, r) {
                    if (c(r), t = s(t, r < 0 ? 0 : 0 | v(r)), !a.TYPED_ARRAY_SUPPORT)
                ...
                function w(t, r, e, n) {
                    ...
                    return r = void 0 === e && void 0 === n ? new Uint8Array(r) : void 0 === n ? new Uint8Array(r, e) : new Uint8Array(r, e, n), a.TYPED_ARRAY_SUPPORT ? (t = r, t.__proto__ = a.prototype) : t = y(t, r), t
                }
                ...
                function R(t, r, e, n, i) {
                    ...
                    if ("string" === typeof r && (r = a.from(r, n)), a.isBuffer(r)) return 0 === r.length ? -1 : _(t, r, e, n, i);
                    if ("number" === typeof r) return r &= 255, a.TYPED_ARRAY_SUPPORT && "function" === typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(t, r, e) : Uint8Array.prototype.lastIndexOf.call(t, r, e) : _(t, [r], e, n, i);
                    ...
                    while (i < e) {
                        ...
                        if (i + c <= e) switch (c) {
                            case 1:
                                ...
                                break;
                            case 2:
                                o = t[i + 1], 128 === (192 & o) && (s = (31 & a) << 6 | 63 & o, s > 127 && (h = s));
                                break;
                            case 3:
                                o = t[i + 1], u = t[i + 2], 128 === (192 & o) && 128 === (192 & u) && (s = (15 & a) << 12 | (63 & o) << 6 | 63 & u, s > 2047 && (s < 55296 || s > 57343) && (h = s));
                                break;
                            case 4:
                                o = t[i + 1], u = t[i + 2], f = t[i + 3], 128 === (192 & o) && 128 === (192 & u) && 128 === (192 & f) && (s = (15 & a) << 18 | (63 & o) << 12 | (63 & u) << 6 | 63 & f, s > 65535 && s < 1114112 && (h = s))
                        }
                        null === h ? (h = 65533, c = 1) : h > 65535 && (h -= 65536, n.push(h >>> 10 & 1023 | 55296), h = 56320 | 1023 & h), n.push(h), i += c
                    }
                    return L(n)
                }
                r.Buffer = a, r.SlowBuffer = b, r.INSPECT_MAX_BYTES = 50, a.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : u(), r.kMaxLength = f(), a.poolSize = 8192, a._augment = function(t) {
                    ...
                    var t = 0 | this.length;
                    return 0 === t ? "" : 0 === arguments.length ? C(this, 0, t) : E.apply(this, arguments)
                ...
                a.prototype.slice = function(t, r) {
                    ...
                    return t = +t, r |= 0, e || z(this, t, r, 1, 255, 0), a.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), this[r] = 255 & t, r + 1
                }, a.prototype.writeUInt16LE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 2, 65535, 0), a.TYPED_ARRAY_SUPPORT ? (this[r] = 255 & t, this[r + 1] = t >>> 8) : F(this, t, r, !0), r + 2
                }, a.prototype.writeUInt16BE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 2, 65535, 0), a.TYPED_ARRAY_SUPPORT ? (this[r] = t >>> 8, this[r + 1] = 255 & t) : F(this, t, r, !1), r + 2
                }, a.prototype.writeUInt32LE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 4, 4294967295, 0), a.TYPED_ARRAY_SUPPORT ? (this[r + 3] = t >>> 24, this[r + 2] = t >>> 16, this[r + 1] = t >>> 8, this[r] = 255 & t) : j(this, t, r, !0), r + 4
                }, a.prototype.writeUInt32BE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 4, 4294967295, 0), a.TYPED_ARRAY_SUPPORT ? (this[r] = t >>> 24, this[r + 1] = t >>> 16, this[r + 2] = t >>> 8, this[r + 3] = 255 & t) : j(this, t, r, !1), r + 4
                    ...
                    return t = +t, r |= 0, e || z(this, t, r, 1, 127, -128), a.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), t < 0 && (t = 255 + t + 1), this[r] = 255 & t, r + 1
                }, a.prototype.writeInt16LE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 2, 32767, -32768), a.TYPED_ARRAY_SUPPORT ? (this[r] = 255 & t, this[r + 1] = t >>> 8) : F(this, t, r, !0), r + 2
                }, a.prototype.writeInt16BE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 2, 32767, -32768), a.TYPED_ARRAY_SUPPORT ? (this[r] = t >>> 8, this[r + 1] = 255 & t) : F(this, t, r, !1), r + 2
                }, a.prototype.writeInt32LE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 4, 2147483647, -2147483648), a.TYPED_ARRAY_SUPPORT ? (this[r] = 255 & t, this[r + 1] = t >>> 8, this[r + 2] = t >>> 16, this[r + 3] = t >>> 24) : j(this, t, r, !0), r + 4
                }, a.prototype.writeInt32BE = function(t, r, e) {
                    return t = +t, r |= 0, e || z(this, t, r, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), a.TYPED_ARRAY_SUPPORT ? (this[r] = t >>> 24, this[r + 1] = t >>> 16, this[r + 2] = t >>> 8, this[r + 3] = 255 & t) : j(this, t, r, !1), r + 4
                    ...
                    if (r >>>= 0, e = void 0 === e ? this.length : e >>> 0, t || (t = 0), "number" === typeof t)
                        ...
                        var u = a.isBuffer(t) ? t : K(new a(t, n).toString()),
                            f = u.length;
        ...
        "1fb5": function(t, r, e) {
            "use strict";
            r.byteLength = h, r.toByteArray = l, r.fromByteArray = y;
            ...
            function l(t) {
                var r, e, n = a(t),
                    ...
                    h = 0,
                    l = f > 0 ? u - 4 : u;
                for (e = 0; e < l; e += 4) r = i[t.charCodeAt(e)] << 18 | i[t.charCodeAt(e + 1)] << 12 | i[t.charCodeAt(e + 2)] << 6 | i[t.charCodeAt(e + 3)], s[h++] = r >> 16 & 255, s[h++] = r >> 8 & 255, s[h++] = 255 & r;
                return 2 === f && (r = i[t.charCodeAt(e)] << 2 | i[t.charCodeAt(e + 1)] >> 4, s[h++] = 255 & r), 1 === f && (r = i[t.charCodeAt(e)] << 10 | i[t.charCodeAt(e + 1)] << 4 | i[t.charCodeAt(e + 2)] >> 2, s[h++] = r >> 8 & 255, s[h++] = 255 & r), s
            }
        ...
        9152: function(t, r) {
            r.read = function(t, r, e, n, i) {
                ...
                var u, f, s, a = 8 * o - i - 1,
                    ...
                    g = n ? 1 : -1,
                    y = r < 0 || 0 === r && 1 / r < 0 ? 1 : 0;
                for (r = Math.abs(r), isNaN(r) || r === 1 / 0 ? (f = isNaN(r) ? 1 : 0, u = h) : (u = Math.floor(Math.log(r) / Math.LN2), r * (s = Math.pow(2, -u)) < 1 && (u--, s *= 2), r += u + c >= 1 ? l / s : l * Math.pow(2, 1 - c), r * s >= 2 && (u++, s /= 2), u + c >= h ? (f = 0, u = h) : u + c >= 1 ? (f = (r * s - 1) * Math.pow(2, i), u += c) : (f = r * Math.pow(2, c - 1) * Math.pow(2, i), u = 0)); i >= 8; t[e + p] = 255 & f, p += g, f /= 256, i -= 8);
        ...
        "968c": function(t, r, e) {
            "use strict";
            e.r(r);
            const n = () => Promise.all([e.e("chunk-9691fd08"), e.e("database")]).then(e.bind(null, "5500")),
                i = async () => (await e.e("localforage").then(e.t.bind(null, "a002", 7))).default,
                o = (t, r, e) => t + r.uid + ("configs" !== e ? "/" + e : ""),
                u = (t, r) => r ? t + r.uid : t.replace(/\//g, ""),
                f = {
                    get: async (t, r, e) => r ? (await n()).get(o(t, r, e)) : (await i()).getItem(e),
                    update: async (t, r, e, u) => r ? (await n()).update(o(t, r, e), u) : f.get(t, r, e).then(async t => (await i()).setItem(e, { ...t,
                        ...u
                    })),
                    remove: async (t, r, e) => r ? (await n()).remove(o(t, r, e)) : (await i()).removeItem(e),
                    local: {}
                };
            f.local.update = async (t, r, e) => {
                const n = u(t, r);
                return (await i()).setItem(n, e)
            }, f.local.get = async (t, r) => {
                const e = u(t, r);
                return (await i()).getItem(e)
            }, f.local.remove = async (t, r) => {
                const e = u(t, r);
                return (await i()).removeItem(e)
            }, f.local.clean = async function(t) {
                const r = await i(),
                    e = await r.keys();
                return Promise.all(e.filter(r => r.includes(t)).map(t => this.remove(t)))
            }, r["default"] = f
        },
        e3db: function(t, r) {
            var e = {}.toString;
