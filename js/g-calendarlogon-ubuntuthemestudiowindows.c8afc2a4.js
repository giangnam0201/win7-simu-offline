(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["g-calendar~logon-ubuntu~themestudio~windows"], {
        "69e8": function(e, t, a) {
            "use strict";
            a("aca5")
        },
        7543: function(e, t, a) {
            ...
            var i = function() {
                ...
                l = {
                    ...
                    mounted() {
                        const e = new s.a({
                            ...
                            monthDisplayType: this.monthType || "long",
                ...
                d = l,
                c = (a("69e8"), a("2877")),
                h = Object(c["a"])(d, i, r, !1, null, null, null);
            t["a"] = h.exports
        },
        "811ec": function(e, t, a) {
            ! function(t, a) {
                e.exports = a()
            }(0, (function() {
                "use strict";
                ...
                return e.prototype.addEventListeners = function() {
                    ...
                    let t = 0;
                    for (let a = e - 4; a <= e + 7; a++) this.pickerYearContainer.children[t].innerText = a.toString(), t++;
                    ...
                    this.filteredEventsThisMonth = this.eventsData.filter(e => {
                        ...
                        for (let i = t; i <= a; i++) this.eventDayMap[i] = !0
        ...
        c466: function(e, t, a) {
            ...
            function r(e, t) {
                ...
                return {
                    day: a.toLocaleDateString(t, {
                        weekday: "long"
                    }),
                    date: a.toLocaleDateString(t, {
                        day: "numeric"
                    }),
                    month: a.toLocaleDateString(t, {
                        month: "long"
                    }),
                    year: a.toLocaleDateString(t, {
                        year: "numeric"
                    })
                }
            }
            ...
            function s(e, t = "/") {
                const a = e ? new Date(e) : new Date;
                return [a.getDate(), a.getMonth() + 1, a.getFullYear()].map(i["k"]).join(t)
            }
        }
    }
]);